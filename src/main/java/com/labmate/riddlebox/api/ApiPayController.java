...
public class ApiPayController {
    ...
    public ResponseEntity<?> kakaoPayRequest_01(@RequestBody OrderInfoDTO orderInfoDTO){
...
//    @PostMapping("kakaopay")
    public ResponseEntity<?> kakaoPayRequest_02(@RequestBody OrderInfoDTO orderInfoDTO){
