...
public class GameRecord extends BaseEntity {
    ...
    private int score;  //점수 (맞춘 개수)
    private int playTime;  //플레이타임(초 기준)
    ...
    /*    생성자    */
    public GameRecord(RBUser user, Game game, int playTime, int score, float successRate, GameResultType resultType) {
        this.user = user;
        this.game = game;
